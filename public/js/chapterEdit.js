...
/* harmony import */ var core_js_modules_es_reflect_get__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core-js/modules/es.reflect.get */ "./node_modules/core-js/modules/es.reflect.get.js");
/* harmony import */ var core_js_modules_es_reflect_get__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_reflect_get__WEBPACK_IMPORTED_MODULE_14__);
...
var PopupBlot = /*#__PURE__*/function (_InlineBlot) {
  _inherits(PopupBlot, _InlineBlot);

  var _super = _createSuper(PopupBlot);

  function PopupBlot() {
    _classCallCheck(this, PopupBlot);

    return _super.apply(this, arguments);
  }

  _createClass(PopupBlot, [{
    key: "format",
    value: function format(name, value) {
      if (name === 'popup' && value) {
        this.domNode.setAttribute('data-popup', value);
      } else {
        _get(_getPrototypeOf(PopupBlot.prototype), "format", this).call(this, name, value);
      }
    }
  }, {
    key: "formats",
    value: function formats() {
      var formats = _get(_getPrototypeOf(PopupBlot.prototype), "formats", this).call(this);
    ...
    key: "create",
    value: function create(popupContent) {
      var node = _get(_getPrototypeOf(PopupBlot), "create", this).call(this, popupContent);
...
PopupBlot.tagName = 'A';
Quill.register({
  'formats/popup': PopupBlot
});
var Tooltip = Quill.import('ui/tooltip');

var PopupTooltip = /*#__PURE__*/function (_Tooltip) {
  _inherits(PopupTooltip, _Tooltip);

  var _super2 = _createSuper(PopupTooltip);

  function PopupTooltip(quill, bounds) {
    var _this;

    _classCallCheck(this, PopupTooltip);

    _this = _super2.call(this, quill, bounds);
    _this.preview = _this.root.querySelector('.ql-preview');
    _this.textbox = _this.root.querySelector('.ql-popuptext');
  ...
  _createClass(PopupTooltip, [{
    ...
    value: function listen() {
      ...
      this.root.querySelector('a.ql-action').addEventListener('click', function (event) {
        if (_this2.root.classList.contains('ql-editing')) {
          ...
          _this2.edit('popup', _this2.preview.textContent);
        }
      ...
      this.root.querySelector('a.ql-remove').addEventListener('click', function (event) {
        if (_this2.linkRange != null) {
          ...
          (_this2$quill = _this2.quill).formatText.apply(_this2$quill, _toConsumableArray(range).concat(['popup', false, 'user']));
      ...
      this.quill.on('selection-change', function (range, oldRange, source) {
        ...
        if (range.length === 0 && source === 'user') {
          var _this2$quill$scroll$d = _this2.quill.scroll.descendant(PopupBlot, range.index),
              _this2$quill$scroll$d2 = _slicedToArray(_this2$quill$scroll$d, 2),
              popup = _this2$quill$scroll$d2[0],
              offset = _this2$quill$scroll$d2[1];

          if (popup != null) {
            var _this2$quill2;

            _this2.linkRange = [range.index - offset, popup.length()];
            var preview = PopupBlot.formats(popup.domNode);
            _this2.preview.textContent = preview;

            _this2.show();

            _this2.position((_this2$quill2 = _this2.quill).getBounds.apply(_this2$quill2, _toConsumableArray(_this2.linkRange)));
    ...
    key: "show",
    value: function show() {
      _get(_getPrototypeOf(PopupTooltip.prototype), "show", this).call(this);
    ...
    value: function save() {
      ...
      if (this.linkRange) {
        ...
        (_this$quill = this.quill).formatText.apply(_this$quill, _toConsumableArray(this.linkRange).concat(['popup', value, 'user']));
...
var PopupModule = /*#__PURE__*/function (_QuillModule) {
  _inherits(PopupModule, _QuillModule);

  var _super3 = _createSuper(PopupModule);

  function PopupModule(quill, options) {
    var _this3;

    _classCallCheck(this, PopupModule);

    _this3 = _super3.call(this, quill, options);
    _this3.tooltip = new PopupTooltip(_this3.quill, options.bounds);

    _this3.quill.getModule('toolbar').addHandler('popup', _this3.popupHandler.bind(_assertThisInitialized(_this3)));

    return _this3;
  }

  _createClass(PopupModule, [{
    key: "popupHandler",
    value: function popupHandler(value) {
      if (value) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var quill = new Quill('#chapter-editor', {
    ...
    formats: ['bold', 'italic', 'underline', 'strike', 'image', 'align', 'removeRaw', 'popup'],
    clipboard: {
      allowed: {
  ...
  if (isJSON(content)) {
    // remove nbsp
    var jsonContent = content.replace(/&nbsp;/g, " ");
    quill.setContents(JSON.parse(jsonContent).ops); // sync the hidden input

    hiddenVal.value = JSON.stringify(quill.getContents());
  } else {
    quill.setText(content); // sync the hidden input
  ...
  quill.on('text-change', function (delta, oldDelta, source) {
    ...
    hiddenVal.value = JSON.stringify(quill.getContents()); // console.log(JSON.parse(hiddenVal.value));
  });
});
...
/***/ 1:
/*!*******************************************!*\
  !*** multi ./resources/js/chapterEdit.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\xampp\htdocs\rosetales.com\resources\js\chapterEdit.js */"./resources/js/chapterEdit.js");
