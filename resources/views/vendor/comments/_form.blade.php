<div class="mt-12">
@include('notice', ['session_status' => 'comment_status'])
</div>

<comment-form action="{{ route('comments.store') }}" @if(isset($guest_commenting) and $guest_commenting == true) guest_commenting @endif>
    @csrf
    @honeypot
